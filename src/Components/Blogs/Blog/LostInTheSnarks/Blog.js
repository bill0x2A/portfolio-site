...
const Blog = () => (
    <MathJax.Provider>
        <div className={classes.Blog}>
            ...
            <MathJax.Node formula={'P(X) = a_{0} + a_{1}X + a_{1}X^{2} + ... + a_{d}X^{d} \\ \\ \\ (a_{0},...,a_{d} \\in \\mathbb{F}_{p})'}/>
            ...
            <MathJax.Node formula={'\\dot b = \\gamma \\cdot b = \\gamma \\cdot \\alpha \\cdot a = \\alpha(\\gamma \\cdot a) = \\alpha \\cdot \\dot a'}/>
            ...
            <MathJax.Node formula={'(g, \\alpha \\cdot g),(s\\cdot g, s\\cdot g \\cdot \\alpha),(s^{2}\\cdot g, \\alpha \\cdot s^{2}\\cdot g),...,(s^{d}\\cdot g, \\alpha \\cdot s^{d}\\cdot g)'}/>
            ...
            <p>With her choosing any <MathJax.Node inline formula={'c_{1},...,c_{d} \\in \\mathbb{F}_{p}'}/>. Now when she outputs <MathJax.Node inline formula={'\\dot a, \\dot b'}/> she proves with <strong>now negligible</strong> probability that she knows <MathJax.Node inline formula={'c_{0},...,c_{d}'}/> such that <MathJax.Node inline formula={'\\sum^{d}_{i=0} c_{i} \\cdot s^{i} \\cdot g = \\dot a'}/>.</p>
