    ...
    return (
        <div className={classes.CV}>
            ...
            <div className={classes.Body}>
                ...
                <p>I am a self driven and independent developer, with a passion to continuously learn. After my first exerience of development in my final year of university I wanted to learn more but decided against paying for more education. I took lockdown as an opportunity to learn HTML, CSS and Javascript, finding my first client for freelance work in May. Wanting to build more than static websites I began learning React in July and have since furthered my skills, winning prizes at the ColoradoJam hackathon and taking on the lead developer role for a small startup.</p>
                <h3>Core Skills</h3>
                <table>
                ...
                <div className={classes.JobHeadline}>
                    <p><strong>Frontend Lead</strong></p><p>Moonwolf.io</p><p>April - June 2021</p>
                </div>
                ...
                <p>A 'yield farm' captured over $2m of value at its peak, I built the frontend for this application in React in under a week as requested by the community surrounding the project and in response to market conditions. <span onClick = {() => window.open("https://farm.moonwolf.io/")}>View here</span></p>
                <p></p>
                <div className={classes.JobHeadline}>
                ...
                <div className={classes.JobHeadline}>
                    <p><strong>Other React Projects</strong></p><p>July 2020 - Present</p>
                </div>
                <p></p>
