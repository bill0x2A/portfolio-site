    ...
    return (
        <div className={classes.CV}>
            ...
            <div className={classes.Body}>
                ...
                <p>I planned and built a <span onClick = {() => window.open("https://master.d1l4h4map9o1uj.amplifyapp.com/")}>collaborative bugtracker web application</span> using React and Firebase, allowing using to create bug reports, comment on bugs and manage their urgency to name a few features.</p>
                ...
                <p>I led several teams of student workers, assigning jobs as issues arose to ensure a smooth running of the event, representing the university to the highest standards.</p>
